...
from SAHIModule.utils.cv import read_image
...
class TestPredict(unittest.TestCase):
    def test_prediction_score(self):
        from SAHIModule.prediction import PredictionScore
    ...
    def test_object_prediction(self):
        from SAHIModule.prediction import ObjectPrediction

    def test_get_prediction_mmdet(self):
        from SAHIModule.models.mmdet import MmdetDetectionModel
        from SAHIModule.predict import get_prediction
        from SAHIModule.utils.mmdet import MmdetTestConstants, download_mmdet_yolox_tiny_model
    ...
    def test_get_prediction_yolov5(self):
        from SAHIModule.models.yolov5 import Yolov5DetectionModel
        from SAHIModule.predict import get_prediction
        from SAHIModule.utils.yolov5 import Yolov5TestConstants, download_yolov5n_model
    ...
    def test_get_prediction_automodel_yolov5(self):
        from SAHIModule.auto_model import AutoDetectionModel
        from SAHIModule.predict import get_prediction
        from SAHIModule.utils.yolov5 import Yolov5TestConstants, download_yolov5n_model
    ...
    def test_get_sliced_prediction_mmdet(self):
        from SAHIModule.models.mmdet import MmdetDetectionModel
        from SAHIModule.predict import get_sliced_prediction
        from SAHIModule.utils.mmdet import MmdetTestConstants, download_mmdet_yolox_tiny_model
    ...
    def test_coco_json_prediction(self):
        from SAHIModule.predict import predict
        from SAHIModule.utils.mmdet import MmdetTestConstants, download_mmdet_yolox_tiny_model
        from SAHIModule.utils.yolov5 import Yolov5TestConstants, download_yolov5n_model
    ...
    def test_video_prediction(self):
        ...
        from SAHIModule.predict import predict
        from SAHIModule.utils.file import download_from_url
        from SAHIModule.utils.yolov5 import Yolov5TestConstants, download_yolov5n_model
