...
from SAHIModule.utils.import_utils import is_available
...
from SAHIModule.models.base import DetectionModel
from SAHIModule.postprocess.combine import (
...
from SAHIModule.prediction import ObjectPrediction, PredictionResult
from SAHIModule.slicing import slice_image
from SAHIModule.utils.coco import Coco, CocoImage
from SAHIModule.utils.cv import (
    IMAGE_EXTENSIONS,
    VIDEO_EXTENSIONS,
...
from SAHIModule.utils.file import Path, increment_path, list_files, save_json, save_pickle
from SAHIModule.utils.import_utils import check_requirements
...
def predict_fiftyone(
    ...
    from SAHIModule.utils.fiftyone import create_fiftyone_dataset_from_coco_file, fo
