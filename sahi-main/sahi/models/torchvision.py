...
class TorchVisionDetectionModel(DetectionModel):
    ...
    def load_model(self):
        ...
        from SAHIModule.utils.torchvision import MODEL_NAME_TO_CONSTRUCTOR
    ...
    def set_model(self, model: Any):
        ...
        from SAHIModule.utils.torchvision import COCO_CLASSES
    ...
    def perform_inference(self, image: np.ndarray, image_size: int = None):
        ...
        """
        from SAHIModule.utils.torch import to_float_tensor
