...
class TestHighLevelApi(unittest.TestCase):
    def test_bounding_box(self):
        from SAHIModule import BoundingBox
    ...
    def test_category(self):
        from SAHIModule import Category
    ...
    def test_object_prediction(self):
        from SAHIModule import ObjectPrediction
    ...
    def test_detection_model(self):
        from SAHIModule import DetectionModel
