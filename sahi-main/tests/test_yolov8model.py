...
from SAHIModule.utils.yolov8 import Yolov8TestConstants, download_yolov8n_model, download_yolov8s_model
...
class TestYolov8DetectionModel(unittest.TestCase):
    def test_load_model(self):
        from SAHIModule.models.yolov8 import Yolov8DetectionModel
