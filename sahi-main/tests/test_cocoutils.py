...
from SAHIModule.utils.coco import merge, update_categories
from SAHIModule.utils.file import load_json


class TestCocoUtils(unittest.TestCase):
    def test_coco_categories(self):
        from SAHIModule.utils.coco import CocoCategory
    ...
    def test_coco_annotation(self):
        from SAHIModule.utils.coco import CocoAnnotation
    ...
    def test_cocovid_annotation(self):
        from SAHIModule.utils.coco import CocoVidAnnotation
    ...
    def test_coco_image(self):
        from SAHIModule.utils.coco import CocoAnnotation, CocoImage, CocoPrediction
    ...
    def test_cocovid_image(self):
        from SAHIModule.utils.coco import CocoVidAnnotation, CocoVidImage
    ...
    def test_coco_video(self):
        from SAHIModule.utils.coco import CocoVidAnnotation, CocoVideo, CocoVidImage
    ...
    def test_get_imageid2annotationlist_mapping(self):
        from SAHIModule.utils.coco import get_imageid2annotationlist_mapping
    ...
    def test_merge_from_list(self):
        from SAHIModule.utils.coco import merge_from_list
    ...
    def test_cocovid(self):
        from SAHIModule.utils.coco import CocoVid

        # TODO

    def test_bbox_clipping(self):
        from SAHIModule.utils.coco import Coco, CocoAnnotation, CocoCategory, CocoImage
