...
from SAHIModule.utils.file import is_colab, load_json, save_json
from SAHIModule.utils.shapely import ShapelyAnnotation, box, get_shapely_multipolygon
...
class Coco:
    ...
    def get_coco_with_clipped_bboxes(self):
        ...
        """
        from SAHIModule.slicing import annotation_inside_slice
