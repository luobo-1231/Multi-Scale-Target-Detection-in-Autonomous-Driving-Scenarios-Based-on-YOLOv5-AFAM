...
from SAHIModule.utils.mmdet import MmdetTestConstants, download_mmdet_cascade_mask_rcnn_model, download_mmdet_yolox_tiny_model
...
class TestMmdetDetectionModel(unittest.TestCase):
    ...
    def test_perform_inference_without_mask_output_with_automodel(self):
        from SAHIModule import AutoDetectionModel
